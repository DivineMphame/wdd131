const mydetails = [
    {
        name:"Tadiwanashe Divine Mphame",
        email:"mphametadiwanshe@gmail.com",
        phone:"+27 614744770"
    }
];
...
getYear.textContent = `© ${year} Tadiwanashe Divine Mphame Pretoria, South Africa.`;
...
downloadButton.addEventListener('click', ()=>{
  ...
  if(resumeFile){
    ...
    link.download = 'Tadiwanashes resume';
    link.click();
